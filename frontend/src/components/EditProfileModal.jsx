...
const EditModal = ({ visible }) => {
   return (<>
      <div className={`border border-blue-400 flex flex-col items-center justify-center gap-3 absolute transition-all top-20 right-15  p-2 w-[9rem] h-[5rem]  bg-black text-white rounded-xl  ${visible === true ? " opacity-100 " : " opacity-0 "}`} >
